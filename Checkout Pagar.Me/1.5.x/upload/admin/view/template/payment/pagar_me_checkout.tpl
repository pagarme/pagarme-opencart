				...
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
					<table class="form">
						...
						<tr>
							...
							<td><select name="pagar_me_checkout_order_authorized" id="pagar_me_checkout_order_authorized">
									<?php foreach ($order_statuses as $order_status) { ?>
						...
						<tr>
							...
							<td><select name="pagar_me_checkout_order_pending_refund" id="pagar_me_checkout_order_pending_refund">
									<?php foreach ($order_statuses as $order_status) { ?>
						...
						<tr>
							...
							<td><select name="pagar_me_checkout_order_processing" id="pagar_me_checkout_order_processing">
									<?php foreach ($order_statuses as $order_status) { ?>
						...
						<tr>
							...
							<td><select name="pagar_me_checkout_order_refused" id="pagar_me_checkout_order_refused">
									<?php foreach ($order_statuses as $order_status) { ?>
