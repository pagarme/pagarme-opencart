        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data"
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"
                               for="input-pagar_me_checkout_order_authorized"><?php echo $entry_order_authorized; ?></label>

                        <div class="col-sm-10">
                            <select name="pagar_me_checkout_order_authorized"
                                    id="input-pagar_me_checkout_order_authorized" class="form-control">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"
                               for="input-pagar_me_checkout_order_paid"><?php echo $entry_order_paid; ?></label>
                        <div class="col-sm-10">
