...
class ControllerPaymentPagarMeCartao extends Controller
{
    ...
    public function index()
    {
        ...
        $this->data['entry_order_pending_review'] = $this->language->get('entry_order_pending_review');
        $this->data['entry_async'] = $this->language->get('entry_async');
        ...
        if (isset($this->request->post['pagar_me_cartao_pending_review'])) {
            $this->data['pagar_me_cartao_order_pending_review'] = $this->request->post['pagar_me_cartao_order_pending_review'];
        } else {
            $this->data['pagar_me_cartao_order_pending_review'] = $this->config->get('pagar_me_cartao_order_pending_review');
        }

        if (isset($this->request->post['pagar_me_cartao_async'])) {
            $this->data['pagar_me_cartao_async'] = $this->request->post['pagar_me_cartao_async'];
        } else {
            $this->data['pagar_me_cartao_async'] = $this->config->get('pagar_me_cartao_async');
        }
