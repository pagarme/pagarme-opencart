...
class ControllerPaymentPagarMeBoleto extends Controller
{
    ...
    public function index()
    {
        ...
        if (isset($this->request->post['pagar_me_boleto_order_authorized'])) {
            $this->data['pagar_me_boleto_order_authorized'] = $this->request->post['pagar_me_boleto_order_authorized'];
        } else {
            $this->data['pagar_me_boleto_order_authorized'] = $this->config->get('pagar_me_boleto_order_authorized');
        }

        if (isset($this->request->post['pagar_me_boleto_order_refused'])) {
            $this->data['pagar_me_boleto_order_refused'] = $this->request->post['pagar_me_boleto_order_refused'];
        } else {
            $this->data['pagar_me_boleto_order_refused'] = $this->config->get('pagar_me_boleto_order_refused');
        }

        if (isset($this->request->post['pagar_me_boleto_order_pending_refund'])) {
            $this->data['pagar_me_boleto_order_pending_refund'] = $this->request->post['pagar_me_boleto_order_pending_refund'];
        } else {
            $this->data['pagar_me_boleto_order_pending_refund'] = $this->config->get('pagar_me_boleto_order_pending_refund');
        }

        if (isset($this->request->post['pagar_me_boleto_order_refunded'])) {
            $this->data['pagar_me_boleto_order_refunded'] = $this->request->post['pagar_me_boleto_order_refunded'];
        } else {
            $this->data['pagar_me_boleto_order_refunded'] = $this->config->get('pagar_me_boleto_order_refunded');
        }

        if (isset($this->request->post['pagar_me_boleto_order_processing'])) {
            $this->data['pagar_me_boleto_order_processing'] = $this->request->post['pagar_me_boleto_order_processing'];
        } else {
            $this->data['pagar_me_boleto_order_processing'] = $this->config->get('pagar_me_boleto_order_processing');
        }
