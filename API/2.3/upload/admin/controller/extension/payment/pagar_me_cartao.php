...
class ControllerExtensionPaymentPagarMeCartao extends Controller {
    ...
    public function index() {
        $this->load->language('extension/payment/pagar_me_cartao');
        ...
        $data['breadcrumbs'][] = array(
            'href' => $this->url->link('extension/payment/pagar_me_cartao', 'token=' . $this->session->data['token'], 'SSL'),
            'text' => $this->language->get('heading_title'),
            'separator' => ' :: '
        );

        $data['action'] = $this->url->link('extension/payment/pagar_me_cartao', 'token=' . $this->session->data['token'], 'SSL');
        ...
        $this->response->setOutput($this->load->view('extension/payment/pagar_me_cartao.tpl', $data));
    }

    private function validate() {

        if (!$this->user->hasPermission('modify', 'extension/payment/pagar_me_cartao')) {
    ...
    public function install() {
        ...
        $this->model_extension_payment_pagar_me_cartao->install();
    }

    public function uninstall() {
        $this->load->model('extension/payment/pagar_me_cartao');
        $this->model_extension_payment_pagar_me_cartao->uninstall();
    }
